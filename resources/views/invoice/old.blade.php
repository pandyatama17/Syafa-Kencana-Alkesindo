...
<body>
    <form action="{{action('InvoiceController@storeInvoice')}}" method="post">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr class="top">
                <td colspan="7">
                    <table>
                        <tr>
                            <td class="title"style="width:500px">
                            ...
                            <td>
                               <table>
                                <tr>
                                   <td>Invoice #</td>
                                  <td>:</td>
                                  <td><input type="text"  class="simplized" style=" width:90%;" name="parent_id" required="true"> <br></td>
                               </tr>
                               <tr>
                                  <td>Created</td>
                                  <td>:</td>
                                  <td>
                                     <input type="date" id="invoice_date" {{-- onchange="countdate(this.value)" --}} class="simplized" style=" width:90%;" name="invoice_date" value="" required> <br>
                                  </td>
                               </tr>
                            </table>
                                {{-- Due &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                        ...
                        <tr>
                            ...
                            <td style="padding:0">
                                 <table>
                                    ...
                                    <tr>
                                       <td colspan="3"><input type="text" class="simplized" placeholder="nama" name="name" value=""></td>
                                    </tr>
                                    <tr>
                                       <td colspan="3"><textarea name="name" class="simplized" rows="2" cols="20"></textarea></td>
                                    </tr>
                                 </table>
                            </td>
                        </tr>
            ...
            <tr class="heading">
                <td style="width:150px">Salesman</td>
                <td style="width:100px">Tanggal Pengiriman</td>
                <td style="width:120px">Pembayaran</td>
            ...
            @for($i=1; $i < $countitems; $i++)
                ...
                <tr class="item" id="item{{$i}}">
                    ...
                    <td style="width:200px">
                        <select class="simplized chosen" name="item{{$i}}" onchange="getItem{{$i}}(this.value)" style="width:200px">
                    ...
                    <td id="namecolumn{{$i}}" style="text-align:center; word-wrap:break-word; height:fixed"></td>
                    <td id="qtycolumn{{$i}}"></td>
                    <td id="pricecolumn{{$i}}"></td>
                ...
                function getItem{{$i}}(str)
                {
                    ...
                    xhttp.onreadystatechange = function()
                    {
                        if (xhttp.readyState == 4 && xhttp.status == 200)
                        {
                            ...
                            document.getElementById("qtycolumn{{$i}}").innerHTML = '<input class="simplized" type="number" name="qty{{$i}}" min="1" max="'+responseText.qty+'" style="width:50%" id="qty{{$i}}" value="1" onchange="ctsub{{$i}}(this.value)">';
                ...
                function ctsub{{$i}}(qty)
                {
                   ...
                   document.getElementById("counttotal").innerHTML = rupiah(total);
                }
    ...
    <script>
      ...
      {
         $('.normal').chosen({disable_search_threshold: 10});
         $('.chosen').chosen();
      });
